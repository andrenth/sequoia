...
(* OASIS_START *)
(* DO NOT EDIT (digest: fe7b05758a0ed4894a46d409aeaa6ff0) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("sequoia_mysql",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args = ["-use-ocamlfind"];
                 run_path = "lib/drivers/mysql"
              });
          ("sequoia_sqlite",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args = ["-use-ocamlfind"];
                 run_path = "lib/drivers/sqlite"
              })
       ];
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the MySQL driver";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                     cs_name = "sequoia_mysql";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "lib/drivers/mysql";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "sequoia";
                   ...
                   {
                      lib_modules = ["Sequoia_mysql"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "sequoia";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the SQLite driver";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                     cs_name = "sequoia_sqlite";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "lib/drivers/sqlite";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "sequoia"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_sequoia.ml"});
               Executable
                 ({
                     cs_name = "ppx_test";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_path = "lib_test/ppx";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "sequoia";
                           InternalLibrary "sequoia_mysql";
                           InternalLibrary "sequoia_ppx"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "t.ml"});
               Executable
                 ({
                     cs_name = "readme_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "readme.ml"});
               Doc
                 ({
                     cs_name = "sequoia";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "Sequoia documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "Sequoia MySQL driver documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "Sequoia SQLite driver documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\192\222\161\154cU#v\2468\229\211F\029Z\248";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
